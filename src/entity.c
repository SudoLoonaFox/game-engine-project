...
Observers need to run code on receiving an update from an entity
...
Entities need to be able to notify observers of an event taken
*/

/*
Entities may be initialized in an array but most access will be by reference
